...
echo "BTWi-fi_Autologin_Script.sh is RUNNING! Press [ctrl] & [c] to stop or test by logging out"
echo "$(date) BTWi-fi_Autologin_Script.sh is RUNNING!" >> /sbin/BTWi-fi_LOG.txt
